package com.example.shadowviewcustom
...
open class ShadowViewCustom @JvmOverloads constructor(context: Context?, attributeSet: AttributeSet? = null, defStyleInt: Int = 0)
